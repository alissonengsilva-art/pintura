...
def _build_module_admin_context(db: Session, module_code: str) -> dict:
    ...
    return {
        ...
        "turn_options": module_context.turn_options,
        "show_turno_responsavel": module_context.show_turno_responsavel,
        "aspecto_option_categories": module_context.aspecto_option_categories,
