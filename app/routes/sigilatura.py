...
def _render_index(
    ...
    *,
    ...
    context = {
        ...
        "page_description": "Entrada principal para iniciar e acompanhar os controles de Sigilatura em andamento ou concluídos.",
        ...
        "schema_error_message": None if sigilatura_schema_available(db) else "Estrutura de Sigilatura não instalada. Execute as migrations.",
